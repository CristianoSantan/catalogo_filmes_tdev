...
class DirectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create director" do
    assert_difference("Director.count") do
      post directors_url, params: { director: { date_birth: @director.date_birth, gender_id: @director.gender_id, name: @director.name, nationality: @director.nationality } }
    end
  ...
  test "should update director" do
    patch director_url(@director), params: { director: { date_birth: @director.date_birth, gender_id: @director.gender_id, name: @director.name, nationality: @director.nationality } }
